...
public class EmbeddedJetty {
    ...
    private static final String CONFIG_LOCATION_PACKAGE = "com.highscores.config";
    ...
    private void startJetty(int port) throws Exception {
        ...
        LOGGER.info("The index page can be accessed by using the link: {}:{}/{}",
                ...
                port,
                "highscores");
        LOGGER.info("The apis can be accessed by using the link: {}:{}/{}",
                InetAddress.getLocalHost().getHostAddress(),
                port,
                "highscores/api/");
        server.join();
    ...
    private static ServletContextHandler getServletContextHandler() throws IOException {
        ServletContextHandler contextHandler = new ServletContextHandler(ServletContextHandler.SESSIONS); // JSP Sessions
